package br.com.alurafoods.pedidos.controller;

import br.com.alurafoods.pedidos.dto.PedidoDto;
import br.com.alurafoods.pedidos.service.PedidoService;
...
public class PedidoController {
    ...
    public String retornaPorta(@Value("${local.server.port}") String porta) {
        return String.format("Requisição responsidada pela instância na porta %s", porta);
    }
